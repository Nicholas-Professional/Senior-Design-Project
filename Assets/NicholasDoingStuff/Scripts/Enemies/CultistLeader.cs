...
public class CultistLeader : EnemyTemplate
{
    public Vector3[] aoe;
    ...
    CultistLeader(){
		...
		stats.Add("WIS", new Stats(15));
		stats.Add("SPD", new Stats(15));
		stats.Add("LCK", new Stats(7));
        HP = (int)(stats["VIT"].Value*4);
        MP = (int)(stats["WIS"].Value*4);
        currentHealth=HP;
    }
    void Start()
    {
    ...
    public override void TakeDamage(int damage) {
		...
		Debug.Log("Cultist Leader Current Health: " + currentHealth); 
	}
