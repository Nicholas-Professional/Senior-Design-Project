...
public class DarkElf : EnemyTemplate
{
    public Vector3[] aoe;
    ...
    DarkElf(){
		...
		stats.Add("VIT", new Stats(17));
		stats.Add("INT", new Stats(8));
		stats.Add("WIS", new Stats(13));
		stats.Add("SPD", new Stats(15));
		stats.Add("LCK", new Stats(7));
        HP = (int)(stats["VIT"].Value*3.5);
    ...
    public override void TakeDamage(int damage) {
		...
		Debug.Log("Dark Elf Current Health: " + currentHealth); 
	}
